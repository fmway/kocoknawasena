...
function App() {
  ...
  const [mode, setMode] = useState('unlogged');
  return (
    <>
      ...
      <div className='body mx-auto min-h-screen'>
        <nav className='bg-primary drop-shadow-xl' id='nav'>
          <div className='flex justify-between mx-auto px-3 py-1'>
            ...
            { mode == "unlogged" ? 
              <button onClick={() => { setMode("login"); setBlur(true)}} className="bg-white hover:bg-blue-500 text-primary font-semibold hover:text-white p-2 my-auto border border-primary hover:border-white rounded">
                Login
              </button>
            :
        ...
        <div className={mode !== "unlogged"? 'blur' : ''}>
